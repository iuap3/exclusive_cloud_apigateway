...
![切换版本](images/img3.1.3-2-1.png)

* 查看历史版本

查看历史版本是为用户提供查看当前环境下发布过的版本信息。选择【查看历史版本】后，进入历史版本页面。

![历史版本查看](images/img3.1.3-3.png)
...
![API网关流量控制](images/img3.5.3-1.jpg)
...
![正则过滤规则配置文件](images/img3.5.3-2.jpg)
